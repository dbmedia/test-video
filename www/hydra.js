...
function(
    ...
    Backbone, Settings,
    Lawnchair, Hydration,
    UpdateView, DownloadView, LoadingView, LoadFailedView
) {
    ...
    var Hydra = Backbone.Model.extend({
        ...
        initialize: function() {
            ...
            //this.sync('remote-read');

            var ctx = this;
            this.plugin.initialize(function(r) {
                console.log(JSON.stringify(r));
                ctx.firstRun = (r.firstRun.toLowerCase() === 'true');
        ...
        parse: function(serverData) {
            ...
            this.set('www_url', serverData['www_url'])
        ...
        confirmDownload: function(force) {
        ...
        download: function() {
            ...
            console.log('****** fetching', this.get('www_url'));
            ...
            this.plugin.fetch(
                ...
                function(msg) {
                    console.log('*** hydration fetch error:');
                    console.log(msg);
                    view = new LoadFailedView({
                        model:context, 
                        message: "failed",
                        retry: context.download.bind(context)
                    });
                }
            );
        },
        ...
        clearCache: function() {
            try {
                ...
                console.log('navigator.app.clearCache not supported');
            }
        },
